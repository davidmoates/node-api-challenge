...
- [x] Mention two parts of Express that you learned about this week.
      it is a framework that is react for backend
      it helps simplify router middleware and making the API

- [x] Describe Middleware?
      Middleware is to help keep simplify the code that we write helping it be DRY

- [x] Describe a Resource?
      everything is a Resource.

- [x] What can the API return to help clients know if a request was successful?
      we can accomplish this with statuses

- [x] How can we partition our application into sub-applications?
      we do this by routing
